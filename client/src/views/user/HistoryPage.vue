  ...
  <div class="page-layout">
    <aside class="dashboard-sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <router-link to="/history" class="nav-item active"><i class="bi bi-clock-history"></i><span>Riwayat & Score</span></router-link>
      </nav>
    </aside>
...
.page-content { padding: 2rem; max-width: 1000px; }
.page-header { margin-bottom: 2rem; }
.page-header h1 { margin: 0; }
.stats-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 1rem; }
.stat-card { background: var(--bg-card); border: 1px solid var(--border-color); border-radius: var(--radius-lg); padding: 1.25rem; display: flex; align-items: center; gap: 1rem; }
.stat-icon { width: 48px; height: 48px; background: rgba(139,92,246,0.2); color: var(--primary); border-radius: var(--radius-md); display: flex; align-items: center; justify-content: center; font-size: 1.25rem; }
.stat-icon.secondary { background: rgba(236,72,153,0.2); color: var(--secondary); }
.stat-icon.accent { background: rgba(6,182,212,0.2); color: var(--accent); }
.stat-icon.success { background: rgba(34,197,94,0.2); color: var(--success); }
.stat-info { display: flex; flex-direction: column; }
.stat-value { font-size: 1.5rem; font-weight: 700; }
.stat-label { font-size: 0.875rem; color: var(--text-muted); }
.section h3 { margin-bottom: 1rem; display: flex; align-items: center; }
.history-list { display: flex; flex-direction: column; gap: 0.5rem; }
.history-item { display: flex; align-items: center; gap: 1rem; padding: 1rem; background: var(--bg-card); border-radius: var(--radius-md); border: 1px solid var(--border-color); }
.item-rank { font-size: 1.5rem; }
.item-date { font-size: 0.8rem; color: var(--text-muted); min-width: 80px; }
.item-info { flex: 1; }
.item-info h4 { margin: 0 0 0.25rem; font-size: 0.95rem; }
.item-info p { margin: 0; font-size: 0.8rem; color: var(--text-muted); }
.item-score { font-weight: 600; color: var(--primary-light); }
