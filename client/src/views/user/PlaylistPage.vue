  ...
  <div class="page-layout">
    <aside class="dashboard-sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <router-link to="/playlists" class="nav-item active"><i class="bi bi-collection-play-fill"></i><span>Playlist Saya</span></router-link>
        ...
        <form @submit.prevent="savePlaylist">
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" v-model="formData.description" rows="3" placeholder="Deskripsi playlist..."></textarea>
            </div>
          </div>
...
.playlists-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 1.5rem; }
.playlist-card { background: var(--bg-card); border: 1px solid var(--border-color); border-radius: var(--radius-lg); overflow: hidden; transition: all var(--transition-normal); }
.playlist-card:hover { border-color: var(--primary); }
.playlist-cover { height: 120px; background: var(--gradient-primary); display: flex; align-items: center; justify-content: center; font-size: 2.5rem; }
.playlist-info { padding: 1rem; }
.playlist-info h4 { margin: 0 0 0.25rem; }
.playlist-info p { margin: 0; color: var(--text-muted); font-size: 0.875rem; }
.playlist-actions { padding: 0 1rem 1rem; display: flex; gap: 0.5rem; }
