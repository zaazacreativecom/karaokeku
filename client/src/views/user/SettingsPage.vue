  ...
  <div class="page-layout">
    <aside class="dashboard-sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <router-link to="/settings" class="nav-item active"><i class="bi bi-gear-fill"></i><span>Pengaturan</span></router-link>
      </nav>
    </aside>
        ...
        <div class="settings-card card">
          ...
          <div class="card-body">
            <form @submit.prevent="updateProfile">
              ...
              <div v-if="profileMessage" :class="['alert', profileSuccess ? 'alert-success' : 'alert-danger']">
                {{ profileMessage }}
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="password" class="form-control" v-model="passwordForm.confirmNewPassword" required>
                  </div>
                </div>
              </div>
              <div v-if="passwordMessage" :class="['alert', passwordSuccess ? 'alert-success' : 'alert-danger']">
                {{ passwordMessage }}
              </div>
...
.settings-card .card-header { padding: 1rem 1.5rem; border-bottom: 1px solid var(--border-color); }
.settings-card .card-header h3 { margin: 0; font-size: 1.125rem; }
