...
final songsListProvider = NotifierProvider<SongsListController, SongsListState>(SongsListController.new);

class SongsListController extends Notifier<SongsListState> {
  late final SongsRepository _repository;

  @override
  SongsListState build() {
    _repository = ref.read(songsRepositoryProvider);
    Future.microtask(() => loadSongs(reset: true));
    return SongsListState.initial();
  }
