...
public abstract class VideoPlayer implements VideoPlayerInstanceApi {
  ...
  @UnstableApi @Nullable private final KaraokeChannelGainAudioProcessor karaokeChannelGainAudioProcessor;
  ...
  public VideoPlayer(
      ...
      @Nullable KaraokeChannelGainAudioProcessor karaokeChannelGainAudioProcessor,
  ...
  @UnstableApi
  public void setAudioChannelMode(boolean vocalOn) {
    if (karaokeChannelGainAudioProcessor == null) {
      return;
    }
    karaokeChannelGainAudioProcessor.setVocalOn(vocalOn);
  }
