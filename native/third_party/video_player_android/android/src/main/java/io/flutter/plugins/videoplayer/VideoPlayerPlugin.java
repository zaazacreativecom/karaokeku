...
public class VideoPlayerPlugin implements FlutterPlugin, AndroidVideoPlayerApi {
  ...
  @Nullable private MethodChannel audioChannel;
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
    ...
    audioChannel =
        new MethodChannel(binding.getBinaryMessenger(), "karaoke/audio_channel");
    audioChannel.setMethodCallHandler(
        (call, result) -> {
          if ("setAudioMode".equals(call.method)) {
            Number playerId = call.argument("playerId");
            Boolean vocalOn = call.argument("vocalOn");
            if (playerId == null || vocalOn == null) {
              result.error("bad_args", "Missing playerId or vocalOn", null);
              return;
            }
